  ...
  return (
    <footer>
      ...
      <section className='lower-footer bg-red-base flex flex-col justify-center items-center text-white p-5 text-xl'>
        ...
        <p className='flex gap-2'>Criado e Desenvolvido por <a className='flex gap-2' href="https://github.com/JhonPrFer" target='_blank'><b className='text-white'>@JhonPrFer</b><Github/></a></p>
      </section> 
    </footer>
  )
}
