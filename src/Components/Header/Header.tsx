  ...
  return (
    <header className='bg-red-strong py-6 px-52 flex justify-between items-center text-white font-bold'>
      ...
      <nav className='flex gap-6'>
        <a className='text-base transition-all nav-link' href="#">Home</a>
        <a className='text-base transition-all nav-link' href="#">Prefeituras</a>
        <a className='text-base transition-all nav-link' href="#">Regiões</a>
      </nav>
